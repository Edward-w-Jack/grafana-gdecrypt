...
- **Flexible Input:** Accepts encrypted payloads in both **Base64** and **Hex** formats.
...
```
git clone [https://github.com/asquishynerd/grafana-gdecrypt.git](https://github.com/asquishynerd/grafana-gdecrypt.git)
cd grafana-gdecrypt
